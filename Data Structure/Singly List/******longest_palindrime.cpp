	...
	while (curr)
	{
         ...
         * sppose : 1 ->2->3-2->1->5;
           ...
           * here in first:
                    ...
                    we cheking whith  prev and next,and suppose that 1 is commonn 
                    and we add extra 1 with for countcommon functon
        ...
        */
         ...
         * sppose : 1 ->2->3-2->1->5;
           ...
           * here in first:
                    ...
                    we cheking whith  prev and next,and suppose ther is no data in between next ,curr
