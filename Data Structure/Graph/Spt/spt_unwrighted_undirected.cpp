...
int main() {
    ...
    /*
        ...
        ! bellmanford diye undirected and unweighted grapher spt ber kora jai
        * for undirected : make directed 
        * for unwighted : define weight 1 for all
    
    */
    vector<Edge> edges = {
        {0, 1, 1}, {0, 3, 1}, {1, 2, 1}, {3,4, 1},
        {1, 0,1}, {3,0, 1}, {2,1,1}, {4,3, 1},

        {3,7, 1}, {4,5, 1}, {4,6, 1}, {4, 7, 1},
        {7,3, 1}, {5,4, 1}, {6,4, 1}, {7,4,1},
